...
- Deterministic dashboard for spending, income, cash flow, categories, merchants, recurring spend, and data quality
...
- Deterministic dashboard and drill-downs into Transactions
